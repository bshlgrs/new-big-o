MethodsParser = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$startRuleFunctions = { MethodsFile: peg$parseMethodsFile },
        peg$startRuleFunction  = peg$parseMethodsFile,
    ...
    function peg$parseWholeExpression() {
